...
router.put('/:id', authMiddleware, (req, res) => {
  ...
  try {
    ...
    prepare('UPDATE services SET title = COALESCE(?, title), description = COALESCE(?, description), icon = COALESCE(?, icon), sort_order = COALESCE(?, sort_order), active = COALESCE(?, active) WHERE id = ?')
